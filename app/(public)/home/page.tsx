...
export const metadata = {
  ...
  description:
    "VetsInTech is a learning platform built to empower veterans with technical skills for the modern workforce. Interactive courses, community support, and career-ready certifications.",
};
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-slate-400">
              A full-featured learning management system with the tools veterans
              need to build their tech careers.
            </p>
          </div>
